 ...
 * file that was distributed with this source code.
 SDWebImage里写了两个协议：SDWebImageCoder和SDWebImageProgressiveCoder。SDWebImageCodersManager遵守SDWebImageCoder协议，SDWebImageImageIOCoder等遵守SDWebImageProgressiveCoder，主要用于设置一些协议和公用标识
 */
...
/**
 ...
 SDWebImageCoder是单个coder，是管理器的操作对象,
 */
