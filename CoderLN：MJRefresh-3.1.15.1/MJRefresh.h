...
#pragma mark - CoderLN：MJRefresh-3.1.15.1 更新目录
/**
 即将废弃automaticallyHidden属性
 @CoderMJLee CoderMJLee released this on 11 Dec 2017 · 24 commits to master since this release
 
 1.建议大家不要去使用mj_footer.automaticallyHidden = YES;
 2.由开发者自己去控制footer的显示和隐藏是最灵活的
 */
