...
#pragma mark UITableView + 下拉刷新 自定义文字
    LNRefreshNormalHeader * norHeader = [LNRefreshNormalHeader headerWithRefreshingTarget:self refreshingAction:@selector(loadNewData)];

    [norHeader beginRefreshing];// 开始刷新
